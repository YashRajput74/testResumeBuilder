...
// export default function AllTemplates({ templates, onSelectTemplate }) {
//   return (
...
import { templates } from '../data/templates'; // ✅ use your template array here

export default function AllTemplatesPage() {
  const navigate = useNavigate();

  const handleSelectTemplate = (template) => {
    navigate(`/resume/${template.id}`); // Or whatever route you use
  };
